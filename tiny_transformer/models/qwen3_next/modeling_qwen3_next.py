# NOTE: Vendored from `transformers` (Qwen3-Next) and adjusted to live under
...
class Qwen3NextGatedDeltaNet(nn.Module):
    ...
    def __init__(self, config: Qwen3NextConfig, layer_idx: int):
        ...
        if (not is_fast_path_available) and os.environ.get("TRANSFORMERS_NO_ADVISORY_WARNINGS") not in (
                "1",
                "true",
                "True",
        ):
    ...
    def forward(
        ...
        use_precomputed_states = (cache_params is not None and cache_params.has_previous_state and seq_len == 1 and
